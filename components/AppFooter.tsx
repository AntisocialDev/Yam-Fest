            ...
            <div className="flex flex-col py-[80px] px-5  sm:px-[50px] h-full gap-20 justify-between">
                <div className="flex flex-col items-center sm:flex-row gap-20 justify-between">
                    <div className="flex flex-col items-center gap-2">
                        <Image loading="lazy" src={whiteLogo} alt="white logo" width={200} height={100}></Image>
                        <div>
                    ...
                    <div className="flex flex-col items-center sm:items-end gap-5">
                        <div className="flex gap-3">
                            <Image loading="lazy" src={instagram} alt="instagram" width={40} height={40}></Image>
                            <Image loading="lazy" src={facebook} alt="facebook" width={40} height={40}></Image>
                            <Image loading="lazy" src={x} alt="x" width={40} height={40}></Image>
                        </div>
                        <div className="flex items-center gap-3">
                            <Image loading="lazy" src={phone} alt="phone" width={24} height={24}></Image>
                            <p className="text-sm">3438881818</p>
                            <p className="text-sm">2771119244</p>
                        </div>
                        <div className="flex items-center gap-3">
                            <Image loading="lazy" src={email} alt="email" width={24} height={24}></Image>
